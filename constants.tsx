...
export const STYLE_CONFIG: Record<NewsStyle, { color: string; icon: React.ReactNode; description: string; bg: string }> = {
  [NewsStyle.LEFT]: {
    color: 'text-blue-800',
    bg: 'bg-blue-50/50 hover:bg-blue-100/50 border-blue-200',
  ...
  [NewsStyle.NEUTRAL]: {
    ...
    bg: 'bg-stone-100 hover:bg-stone-200 border-stone-300',
  ...
  [NewsStyle.RIGHT]: {
    color: 'text-red-800',
    bg: 'bg-red-50/50 hover:bg-red-100/50 border-red-200',
  ...
  [NewsStyle.SATIRE]: {
    ...
    bg: 'bg-purple-50/50 hover:bg-purple-100/50 border-purple-200',
    description: 'Humor.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
  ...
  [NewsStyle.ELI12]: {
    ...
    bg: 'bg-emerald-50/50 hover:bg-emerald-100/50 border-emerald-200',
  ...
  [NewsStyle.FICTION]: {
    ...
    bg: 'bg-amber-50/50 hover:bg-amber-100/50 border-amber-200',
    description: 'Story.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
